    ...
    public static function all(): array
    {
        return [
            ...
            'tidak_lolos' => [
                ...
                'body' => "Assalamu'alaikum Wr. Wb.\n\nDengan ini disampaikan kepada bapak/ibu :nama.\n\nBerdasarkan hasil seleksi tes yang telah bapak/ibu ikuti sebelumnya untuk :loker, mohon maaf saat ini hasil tes bapak/ibu belum bisa untuk lanjut ke tahap seleksi berikutnya (:tahap). Kami mengucapkan terima kasih atas kesediaan bapak/ibu mengikuti tahapan tes yang kami adakan.\n\nTerimakasih.",
            ],
            'ditolak' => [
                'label' => 'Ditolak',
                'subject' => 'Info Lamaran :loker',
